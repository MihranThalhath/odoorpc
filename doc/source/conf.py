#
# OdooRPC documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('./../..'))  # To find 'sphinx_ext' package
...
project = u'OdooRPC'
copyright = u'2014-{}, Sébastien Alix'.format(datetime.now().year)
...
latex_documents = [
    ('index', 'OdooRPC.tex', u'OdooRPC Documentation', u'Sébastien Alix', 'manual'),
]
...
man_pages = [('index', 'odoorpc', u'OdooRPC Documentation', [u'Sébastien Alix'], 1)]
